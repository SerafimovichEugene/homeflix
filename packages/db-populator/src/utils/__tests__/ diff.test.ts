...
describe('getDiff function', () => {
  ...
  it('should find new, deleted and restored files', () => {
    ...
    const sourceFiles = [fileLoc1, fileLoc2, fileLoc4]
    ...
    const fileDb4 = new VideoFileModel(uuid(name4, uuid.DNS), name4, 'test/path', false, false, '', 0)

    const populatingFiles: VideoFileModel[] = [fileDb2, fileDb3, fileDb4]
    ...
    expect(getDiff(sourceFiles, populatingFiles)).toEqual([[fileRes1], [fileRes3], [fileRes4]])
  })
})
