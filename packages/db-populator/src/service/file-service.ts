...
import { ScreeenshotService } from "./screenshot-service";

export class FileService {
    private ss: ScreeenshotService
    constructor() {
      this.ss = new ScreeenshotService()
    }
    public getFiles(): VideoFile[] {
      ...
      const result = FileService.readFiles(FILE_ROOT_DIR, [])
      .filter((item) => {
